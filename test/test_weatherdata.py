...
ipm = IPM()
public_bylocation = ipm.get_weatherdatasource(
    access_type="location", authentication_type="NONE"
)
public_bystations = ipm.get_weatherdatasource(
    access_type="stations", authentication_type="NONE"
)
private_bystations = ipm.get_weatherdatasource(
    access_type="stations", authentication_type="CREDENTIALS"
)
...
private_bystations = {
    k: v for k, v in private_bystations.items() if k in ipm_credentials
}
